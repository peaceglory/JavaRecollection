package oop.design.patterns.dzone.adapter.client;

import oop.design.patterns.dzone.adapter.target.SortListAdapter;
import oop.design.patterns.dzone.adapter.target.Sorter;
