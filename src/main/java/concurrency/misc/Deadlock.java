...
/**
 * Example of a class that often will lead to deadlock adapted from the <em> Java Tutorials</em> "Concurrency" section on "Deadlock":
...
public class Deadlock {
    ...
    /**
     * Simple executable function that demonstrates deadlock when two friends are waiting on each other to bow to finish bowing.
     *
    ...
    public static void main(final String[] arguments) {
        ...
        new Thread(() -> alphonse.bow(gaston), "Gaston Bowing").start();
        new Thread(() -> gaston.bow(alphonse), "Alphonse Bowing").start();
    }
}
