...
public class MyBinaryTreeTest  {
    ...
    public static MyBinaryTree<Integer> createIntegerTree() {
        return new MyBinaryTree(10, new MyBinaryTree(25, new MyBinaryTree(16, new MyBinaryTree(70), new MyBinaryTree(24, new MyBinaryTree(81, new MyBinaryTree(92), new MyBinaryTree(100)), new MyBinaryTree(34))), new MyBinaryTree(33, new MyBinaryTree(41), new MyBinaryTree(50))), new MyBinaryTree(11, new MyBinaryTree(27), new MyBinaryTree(88, new MyBinaryTree(61, new MyBinaryTree(58), new MyBinaryTree(77)), new MyBinaryTree(39))));
    }
